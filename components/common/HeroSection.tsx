        ...
        <section className="relative w-full flex flex-col items-center">
            ...
            <div className="relative w-full h-[80vh] min-h-[600px] flex items-center justify-center">
                ...
                <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center -mt-20">
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight drop-shadow-xl">
                        Don't just visit. Live it.
                    </h1>
                    <p className="mt-4 text-lg md:text-xl text-white/90 max-w-2xl font-medium drop-shadow-md">
                        Connect with local experts for authentic, off-the-beaten-path experiences.
                    </p>
                </div>
            </div>

            {/* --- 2. Floating Search Bar (Overlapping) --- */}
            {/* Negative margin pulls this up to overlap the image */}
