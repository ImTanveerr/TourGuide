          ...
          <div className="relative group overflow-hidden rounded-3xl h-[400px] md:h-[500px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
              ...
              <Link
                ...
                className="w-fit bg-white hover:bg-gray-100 text-yellow-600 px-8 py-4 rounded-xl font-bold flex items-center transition-all duration-300 group-hover:translate-x-2"
              >
